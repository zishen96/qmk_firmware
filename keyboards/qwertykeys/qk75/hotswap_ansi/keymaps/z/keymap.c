...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT_qk75_ansi(
		...
		MO(1),	 KC_A,    KC_S,    KC_D,   KC_F,     KC_G,    KC_H,    KC_J,    KC_K,    KC_L,   KC_SCLN, KC_QUOT, KC_BSLS, KC_ENT,  KC_END, 
	...
	[1] = LAYOUT_qk75_ansi(
		...
		Z_mcLCL, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,          KC_TRNS, 
		...
		KC_TRNS,          KC_TRNS, KC_TRNS,          Z_mcSPC,                            KC_TRNS, KC_TRNS,          KC_TRNS, KC_TRNS, KC_TRNS 
	),
	...
	bool encoder_update_user(uint8_t index, bool clockwise) {
		...
		if (index == 0) {
			if (clockwise) {
				tap_code_delay(KC_VOLU,8);
			} else {
				tap_code_delay(KC_VOLD,8);
			}
		}
		return false;
	}
