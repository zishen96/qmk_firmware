...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT_qk75_ansi(
		...
		Z_mcLCL, KC_A,    KC_S,    KC_D,   KC_F,     KC_G,    KC_H,    KC_J,    KC_K,    KC_L,   KC_SCLN, KC_QUOT, KC_BSLS, KC_ENT,  KC_END, 
	...
	[1] = LAYOUT_qk75_ansi(
		...
		KC_TRNS,          KC_TRNS, KC_TRNS,          Z_mcSPC,                            KC_TRNS, KC_CAPS,          KC_TRNS, KC_TRNS, KC_TRNS 
	),
